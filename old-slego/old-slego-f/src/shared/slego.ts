...
export class Game {
    ...
    constructor(readonly pieces: Piece[]) {
        this.rounds = pieces.length;
    }

    static random(rounds: number = 40, seed?: string | undefined) {
        let pieces = Game.getRandomGamePieces(rounds, seed);
...
export class Round {
    ...
    private constructor(readonly game: Game, previousRound: Round | null, args: NextRoundArgs) {
        ...
        this.piece = this.game.pieces[this.roundNo - 1] ?? null;
